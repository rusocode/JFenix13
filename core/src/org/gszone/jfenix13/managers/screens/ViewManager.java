...
public abstract class ViewManager {
	...
	protected void setScreen(Screen scr) {
	...
	protected ServerPackages getSvPack() {
		return Main.getInstance().getConnection().getSvPack();
	}
	...
	protected GameData getGD() {
		return Main.getInstance().getGameData();
	}

	protected String bu(String key) {
