 ...
 * pantalla) se guarda su referencia para poder liberarlas de la memoria al cerrar la pantalla (mÃ©todo dispose() )
 */
public abstract class View implements Screen {
	...
	protected Drawable getDrawable(String name, boolean borders) {
		...
		/* Toma una imagen y la convierte en NinePatch, para poder definirle bordes y asÃ­ permitir mover ventanas (si fuera
		 * Ã©ste el caso) */
	...
	/**
	 * Actualiza el tamaño del viewport segun el nuevo tamaño de la pantalla
	 */
	@Override
	...
	// Accesos rapidos desde las pantallas...
	public void setScreen(Screen scr) {
		Main.getInstance().setScreen(scr);
	}
